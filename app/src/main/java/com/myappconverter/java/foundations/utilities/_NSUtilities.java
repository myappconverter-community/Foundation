...
public class _NSUtilities {
	...
	public static boolean _isClassANumber(Class<?> valueClass) {
		...
		return ((valueClass == Number.class) || (valueClass == int.class) || (valueClass == Integer.class) || (valueClass == double.class)
				|| (valueClass == Double.class) || (valueClass == long.class) || (valueClass == Long.class) || (valueClass == float.class)
				|| (valueClass == Float.class) || (valueClass == byte.class) || (valueClass == Byte.class) || (valueClass == short.class)
				|| (valueClass == Short.class) || (valueClass == BigDecimal.class) || (valueClass == BigInteger.class));
	}
	 ...
	 */
	public static void memcpy(Object[] destination, Object[] source, int len) {
		for (int i = 0; i < len; i++) {
