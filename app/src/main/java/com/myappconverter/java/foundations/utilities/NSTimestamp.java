...
public class NSTimestamp extends Timestamp {
	...
	private static final long serialVersionUID = -5841431496772413407L;
	...
	public static final long DistantPastJSTime = -8640000000000000L; // 100,000,000
																		// days
																		// before
																		// Epoch
	public static final long DistantFutureJSTime = 8640000000000000L; // 100,000,000
																		// days
																		// after
																		// Epoch
	...
	public boolean equalsNSTimestamp(Timestamp ts) {
